...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
        ...
        <nav class="bg-gradient-to-r from-amber-600 to-orange-600 border-b border-amber-500">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center">
                            ...
                            <span class="ml-2 text-white font-bold text-lg">EcoFlow Técnico</span>
                        </div>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button
                                    class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-amber-700 hover:bg-amber-800 focus:outline-none transition ease-in-out duration-150">
